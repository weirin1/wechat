...
use Weirin\Wechat\Pay\Api as WxPayApi;
use Weirin\Wechat\Pay\Data\MicroPay as PayMicroPayData;
use Weirin\Wechat\Pay\Data\OrderQuery as PayOrderQueryData;
use Weirin\Wechat\Pay\Data\Reverse as PayReverseData;
...
class MicroPay
{
	/**
	 * 提交刷卡支付，并且确认结果，接口比较慢
	 * @param PayMicroPayData $microPayInput
	 * @throws ErrorException
	 * @return 返回查询接口的结果
	 */
	public function pay(PayMicroPayData $microPayInput)
	{
		//①、提交被扫支付
			...
			|| !array_key_exists("result_code", $result))
		{
			...
			throw new ErrorException("接口调用失败！");
		}
		...
		{
			throw new ErrorException("撤销单失败！");
		}
	...
	{
		$queryOrderInput = new PayOrderQueryData();
